...
// switch.wast:130
assert_return(() => call($1, "expr", [0n]), 0n);

// switch.wast:131
assert_return(() => call($1, "expr", [1n]), -1n);

// switch.wast:132
assert_return(() => call($1, "expr", [2n]), -2n);

// switch.wast:133
assert_return(() => call($1, "expr", [3n]), -3n);

// switch.wast:134
assert_return(() => call($1, "expr", [6n]), 101n);

// switch.wast:135
assert_return(() => call($1, "expr", [7n]), -5n);

// switch.wast:136
assert_return(() => call($1, "expr", [-10n]), 100n);
