...
// if.wast:648
assert_return(() => call($1, "break-multi-value", [0]), -18, 18, -18n);

// if.wast:651
assert_return(() => call($1, "break-multi-value", [1]), 18, -18, 18n);
...
// if.wast:671
assert_return(() => call($1, "add64_u_with_carry", [0n, 0n, 0]), 0n, 0);

// if.wast:675
assert_return(() => call($1, "add64_u_with_carry", [100n, 124n, 0]), 224n, 0);

// if.wast:679
assert_return(() => call($1, "add64_u_with_carry", [-1n, 0n, 0]), -1n, 0);

// if.wast:683
assert_return(() => call($1, "add64_u_with_carry", [-1n, 1n, 0]), 0n, 1);

// if.wast:687
assert_return(() => call($1, "add64_u_with_carry", [-1n, -1n, 0]), -2n, 1);

// if.wast:691
assert_return(() => call($1, "add64_u_with_carry", [-1n, 0n, 1]), 0n, 1);

// if.wast:695
assert_return(() => call($1, "add64_u_with_carry", [-1n, 1n, 1]), 1n, 1);

// if.wast:699
assert_return(() => call($1, "add64_u_with_carry", [-9_223_372_036_854_775_808n, -9_223_372_036_854_775_808n, 0]), 0n, 1);

// if.wast:704
assert_return(() => call($1, "add64_u_saturated", [0n, 0n]), 0n);

// if.wast:707
assert_return(() => call($1, "add64_u_saturated", [1_230n, 23n]), 1_253n);

// if.wast:710
assert_return(() => call($1, "add64_u_saturated", [-1n, 0n]), -1n);

// if.wast:713
assert_return(() => call($1, "add64_u_saturated", [-1n, 1n]), -1n);

// if.wast:716
assert_return(() => call($1, "add64_u_saturated", [-1n, -1n]), -1n);

// if.wast:719
assert_return(() => call($1, "add64_u_saturated", [-9_223_372_036_854_775_808n, -9_223_372_036_854_775_808n]), -1n);
