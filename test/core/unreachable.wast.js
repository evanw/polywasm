...
assert_trap(() => call($1, "type-f32", []));

// unreachable.wast:224
assert_trap(() => call($1, "type-f64", []));
...
assert_trap(() => call($1, "as-return-value", []));
...
assert_trap(() => call($1, "as-local.tee-value", []));

// unreachable.wast:281
assert_trap(() => call($1, "as-global.set-value", []));

// unreachable.wast:283
assert_trap(() => call($1, "as-load-address", []));

// unreachable.wast:284
assert_trap(() => call($1, "as-loadN-address", []));
