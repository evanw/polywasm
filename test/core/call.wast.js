...
// call.wast:289
assert_return(() => call($1, "type-i32-i64", []), 306, 356n);
...
// call.wast:301
assert_return(() => call($1, "type-all-i32-f64", []), 32, float64(4_610_064_722_561_534_525n));

// call.wast:302
assert_return(() => call($1, "type-all-i32-i32", []), 2, 1);

// call.wast:303
assert_return(() => call($1, "type-all-f32-f64", []), float64(4_611_686_018_427_387_904n), float32(1_065_353_216));

// call.wast:304
assert_return(() => call($1, "type-all-f64-i32", []), 2, float64(4_607_182_418_800_017_408n));
