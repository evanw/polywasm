...
run(() => call($1, "init", [0, 1, 2]));

// memory_init0.wast:20
assert_return(() => call($1, "load8_u", [0]), 187);

// memory_init0.wast:21
assert_return(() => call($1, "load8_u", [1]), 204);

// memory_init0.wast:22
assert_return(() => call($1, "load8_u", [2]), 0);

// memory_init0.wast:25
run(() => call($1, "init", [65_532, 0, 4]));

// memory_init0.wast:28
assert_trap(() => call($1, "init", [65_534, 0, 3]));

// memory_init0.wast:30
assert_return(() => call($1, "load8_u", [65_534]), 204);

// memory_init0.wast:31
assert_return(() => call($1, "load8_u", [65_535]), 221);

// memory_init0.wast:34
run(() => call($1, "init", [65_536, 0, 0]));

// memory_init0.wast:35
run(() => call($1, "init", [0, 4, 0]));

// memory_init0.wast:38
assert_trap(() => call($1, "init", [65_537, 0, 0]));

// memory_init0.wast:40
assert_trap(() => call($1, "init", [0, 5, 0]));
