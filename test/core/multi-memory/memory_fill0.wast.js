...
run(() => call($1, "fill", [1, 255, 3]));

// memory_fill0.wast:19
assert_return(() => call($1, "load8_u", [0]), 0);

// memory_fill0.wast:20
assert_return(() => call($1, "load8_u", [1]), 255);

// memory_fill0.wast:21
assert_return(() => call($1, "load8_u", [2]), 255);

// memory_fill0.wast:22
assert_return(() => call($1, "load8_u", [3]), 255);

// memory_fill0.wast:23
assert_return(() => call($1, "load8_u", [4]), 0);

// memory_fill0.wast:26
run(() => call($1, "fill", [0, 48_042, 2]));

// memory_fill0.wast:27
assert_return(() => call($1, "load8_u", [0]), 170);

// memory_fill0.wast:28
assert_return(() => call($1, "load8_u", [1]), 170);

// memory_fill0.wast:31
run(() => call($1, "fill", [0, 0, 65_536]));

// memory_fill0.wast:34
assert_trap(() => call($1, "fill", [65_280, 1, 257]));

// memory_fill0.wast:36
assert_return(() => call($1, "load8_u", [65_280]), 0);

// memory_fill0.wast:37
assert_return(() => call($1, "load8_u", [65_535]), 0);

// memory_fill0.wast:40
run(() => call($1, "fill", [65_536, 0, 0]));

// memory_fill0.wast:43
assert_trap(() => call($1, "fill", [65_537, 0, 0]));
