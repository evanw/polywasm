...
// local_tee.wast:286
assert_return(() => call($1, "type-param-i64", [3n]), 11n);

// local_tee.wast:287
assert_return(() => call($1, "type-param-f32", [float32(1_082_969_293)]), float32(1_093_769_626));

// local_tee.wast:288
assert_return(() => call($1, "type-param-f64", [float64(4_617_878_467_915_022_336n)]), float64(4_623_057_607_486_498_406n));
...
// local_tee.wast:338
assert_return(() => call($1, "as-unary-operand", [float32(0)]), float32(-8_326_686));
...
// local_tee.wast:344
assert_return(() => call($1, "as-convert-operand", [0n]), 41);
...
// local_tee.wast:353
assert_return(() => call($1, "write", [1n, float32(1_073_741_824), float64(4_614_613_358_185_178_726n), 4, 5]), 56n);

// local_tee.wast:360
assert_return(() => call($1, "result", [-1n, float32(-1_073_741_824), float64(-4_608_758_678_669_597_082n), -4, -5]), float64(4_630_094_481_904_264_806n));
