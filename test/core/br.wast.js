...
// br.wast:382
assert_return(() => call($1, "type-i64-value", []), 2n);

// br.wast:383
assert_return(() => call($1, "type-f32-value", []), float32(1_077_936_128));

// br.wast:384
assert_return(() => call($1, "type-f64-value", []), float64(4_616_189_618_054_758_400n));

// br.wast:385
assert_return(() => call($1, "type-f64-f64-value", []), float64(4_616_189_618_054_758_400n), float64(4_617_315_517_961_601_024n));
...
// br.wast:406
assert_return(() => call($1, "as-return-value", []), 7n);

// br.wast:407
assert_return(() => call($1, "as-return-values", []), 2, 7n);
...
// br.wast:437
assert_return(() => call($1, "as-load-address", []), float32(1_071_225_242));

// br.wast:438
assert_return(() => call($1, "as-loadN-address", []), 30n);
...
// br.wast:447
assert_return(() => call($1, "as-unary-operand", []), float32(1_079_613_850));

// br.wast:449
assert_return(() => call($1, "as-binary-left", []), 3);

// br.wast:450
assert_return(() => call($1, "as-binary-right", []), 45n);
